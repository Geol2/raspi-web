                ...
                <div class="my-auto">
                    ...
                    <div class="lead mb-5">
                        ...
                        <ul class="fa-ul mb-0">
                            ...
                            <li>
                                <?php echo "AP_CODE &nbsp &nbsp IP<br>".$row1['AP_CODE'].", &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp ".$row1['PUBLIC_IP'] ?> </li><br>
                            <?php } ?>
                        </ul>
                        ...
                        <ul class="fa-ul mb-0">
                            ...
                            <?php while($row2 = mysqli_fetch_array($select_query2)) { ?>
                                <li>
                                    <?php echo "SF_CODE &nbsp &nbsp IP<br>".$row2['SF_CODE']." &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp ".$row2['INNER_IP'] ?> </li><br>
