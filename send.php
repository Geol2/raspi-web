...
// sf 8 ~ 20라인 수정 했는데 문제발생 가능성이 보일 수 있음.
    ...
    if( $num >= 1) {
        ...
        $current_time = date('D M d Y H:i:s O');
        ...
        $temp = ['t' => $_GET['t'], 'h' => $_GET['h'], 'wt' => $_GET['wt'], 'wl' => $_GET['wl'], 'e' => $_GET['e'], 'd' => $current_time, 'sf' => $_GET['sf'], 'ap' => $value, 'ec' => $_GET['ec'], 'ph'=> $_GET['ph'], 'mip' => $_GET['mip']];
